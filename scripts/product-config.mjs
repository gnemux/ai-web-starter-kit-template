...
export function generatedSupabaseConfig(config) {
  ...
  return `project_id = "${project}"\n\n[api]\nenabled = true\nport = 55321\nschemas = ["public", "graphql_public"]\nextra_search_path = ["public", "extensions"]\nmax_rows = 1000\n\n[db]\nport = 55322\nshadow_port = 55320\nmajor_version = 17\n\n[studio]\nenabled = true\nport = 55323\napi_url = "http://127.0.0.1"\n\n[inbucket]\nenabled = true\nport = 55324\n\n[auth]\nenabled = true\nsite_url = "http://localhost:3000"\nadditional_redirect_urls = ["http://localhost:3000/auth/confirm**", "http://127.0.0.1:3000/auth/confirm**", "http://localhost:3000/auth/recovery**", "http://127.0.0.1:3000/auth/recovery**", "http://localhost:3000/auth/oauth/callback**", "http://127.0.0.1:3000/auth/oauth/callback**"]\njwt_expiry = 3600\nenable_signup = true\n\n[auth.email.template.recovery]\nsubject = "Reset your product password"\ncontent_path = "./supabase/templates/recovery.html"\n\n[realtime]\nenabled = false\n\n[storage]\nenabled = false\n\n[edge_runtime]\nenabled = false\n\n[analytics]\nenabled = false\n`;
}
