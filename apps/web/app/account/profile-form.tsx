...
export function ProfileForm({ initialName, labels }: { initialName: string; labels: { displayName: string; displayNameHint: string; save: string; saving: string; success: string; error: string; dismiss: string } }) {
