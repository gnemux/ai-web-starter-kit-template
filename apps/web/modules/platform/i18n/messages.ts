...
export const platformMessages = {
  "en-US": {
    ...
    recoveryTitle: "Continue password recovery", recoveryDescription: "For your security, continue only after you opened a reset email yourself.", recoveryReady: "The reset link is ready. Continue to create the recovery session.", verifyingRecovery: "Checking the reset link…", continueRecovery: "Continue securely", invalidRecovery: "This reset link is invalid, expired or already used.", requestNewRecovery: "Request a new reset email",
    recoveryPasswordTitle: "Set a new password", recoveryPasswordDescription: "This page is available only to the verified recovery session.", updatePassword: "Set new password", updatePasswordDescription: "Choose a new password for the signed-in recovery session.", passwordUpdated: "Your password has been updated.", passwordUpdateFailed: "The password could not be updated. Request a fresh reset link and try again.", passwordMismatch: "The passwords do not match.", passwordTooShort: "Use at least 8 characters.", savingPassword: "Saving password…", returnToProduct: "Continue to product",
    continueWithGoogle: "Continue with Google", openingGoogle: "Opening Google…", checkingSocialSignIn: "Checking Google sign-in…", socialSignInUnavailable: "Google sign-in is unavailable or was cancelled. Use email or try again later.", continueWithApple: "Continue with Apple", appleDeferred: "Apple sign-in is intentionally disabled until the product owner supplies an Apple Developer configuration.",
    ...
    profileSaved: "Profile saved.", profileFailed: "The profile could not be saved. Review the value and try again.", completeProfile: "Save and continue", completeProfileDescription: "Add a display name to finish setting up this account, then continue to the product.", dismissNotification: "Dismiss notification",
    confirmSignOutTitle: "Sign out?", confirmSignOutDescription: "You will return to the public home page and can sign in again at any time.", confirmSignOut: "Sign out now", cancel: "Cancel", closeDialog: "Close dialog",
  ...
  "zh-CN": {
    ...
    recoveryTitle: "继续找回密码", recoveryDescription: "为保障账户安全，请仅在你本人打开重置邮件后继续。", recoveryReady: "重置链接已准备好，请继续建立安全的找回会话。", verifyingRecovery: "正在检查重置链接…", continueRecovery: "安全继续", invalidRecovery: "该重置链接无效、已过期或已被使用。", requestNewRecovery: "重新申请重置邮件",
    recoveryPasswordTitle: "设置新密码", recoveryPasswordDescription: "只有通过邮件验证的找回会话才能访问此页面。", updatePassword: "设置新密码", updatePasswordDescription: "为当前已验证的找回密码会话设置新密码。", passwordUpdated: "密码已更新。", passwordUpdateFailed: "密码更新失败，请重新申请重置链接后再试。", passwordMismatch: "两次输入的密码不一致。", passwordTooShort: "请至少使用 8 个字符。", savingPassword: "正在保存密码…", returnToProduct: "继续进入产品",
    continueWithGoogle: "使用 Google 继续", openingGoogle: "正在打开 Google…", checkingSocialSignIn: "正在检查 Google 登录…", socialSignInUnavailable: "Google 登录暂时不可用或已取消，请使用邮箱登录或稍后重试。", continueWithApple: "使用 Apple 继续", appleDeferred: "Apple 登录暂不启用，需由产品负责人提供 Apple Developer 配置后再开启。",
    ...
    profileSaved: "资料已保存。", profileFailed: "资料保存失败，请检查内容后重试。", completeProfile: "保存并继续", completeProfileDescription: "请补充显示名称以完成账户设置，保存后继续进入产品。", dismissNotification: "关闭通知",
    confirmSignOutTitle: "确认退出？", confirmSignOutDescription: "退出后将返回公开首页，之后可以随时重新登录。", confirmSignOut: "确认退出", cancel: "取消", closeDialog: "关闭对话框",
